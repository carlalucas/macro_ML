...
# 0. CONFIGURATION
# ==============================================================================
print("INITIALIZATION (SECTION 4.3 - EPU CLEAN)...")
...
# ==============================================================================
# 1. ROBUST LOADING (WITH CLEAN MAPPING)
# ==============================================================================
...
try:
    ...
    for i in range(min(theta.shape[1], phi.shape[1])):
        # phi.columns[i] contient le nom propre (ex: "Recession")
    ...
    print(f"   -> Mapping loaded for {len(labels_map)} topics (Clean Names).")

except Exception as e:
    print(f"Error loading local files (theta/phi): {e}")
    exit()
...
common = common[common <= END_DATE_PAPER] # Cut at 2017
...
def analyze_epu_category(cat_name, y_series):
    ...
    for _, row in res.iterrows():
        # ICI LE MAPPING PREND EFFET : On affiche le nom propre
